...
public class CreateService {
  ...
  public void initCreateMock() {
    Member AdminMember = createMember("관리자","admin","123456789a!");
      ...
      Item item6 = createItem("고구마튀김", "/potatofrench.jpg", "고구마튀김 입니다.", "달콤한 고구마를 두툼하게 썰어 바삭하게 튀겨낸 고구마튀김입니다. 겉은 바삭하고 속은 촉촉하며, 특유의 은은한 단맛이 입맛을 돋웁니다.", 4000, 5, Category.ROAST, SubCategory.FRIED, ItemStatus.NEW);
