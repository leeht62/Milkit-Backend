...
public class CreateService {
  ...
  public void initCreateMock() {
      ...
      Item item1 = createItem("부대찌개" , "/kit1.jpg","부대찌개입니다.",10000,5,Category.SOUP);
      Item item2 = createItem("김치찌개" , "/kimchi.jpg","김치찌개입니다.",15000,5,Category.SOUP);
      Item item3 = createItem("된장찌개" , "/dwon.jpg","된장찌개입니다.",9000,5,Category.SOUP);
      Item item4 = createItem("초밥" , "/Sushi.jpg","초밥입니다.",10000,5,Category.ROAST);
      Item item5 = createItem("감자튀김" , "/french.jpg","감자튀김입니다.",3000,5,Category.ROAST);
      Item item6 = createItem("고구마튀김" , "/french.jpg","고구마튀김입니다.",4000,5,Category.ROAST);
  ...
  private Item createItem(String name, String image, String content, int price, int stock, Category category) {
    Item item=new Item();
    item.setName(name);
    item.setImage(image);
