...
public class CreateService {
  ...
  public void initCreateMock() {
      ...
      Item item7 = createItem("해산물토마토파스타", "/seatomatopasta.jpg", "해산물이 들어간 토마토 파스타입니다.", 13000, 5, Category.PASTA, SubCategory.Noodle);
      Item item8 = createItem("토마토해장파스타", "/tomatohaejangPasta.jpg", "해장용 토마토 파스타입니다.", 12000, 5, Category.PASTA, SubCategory.Noodle);
      Item item9 = createItem("크림나베", "/creamNabe.jpg", "크림이 들어간 일본식 나베입니다.", 14000, 5, Category.SOUP, SubCategory.Noodle);
