...
public class CreateService {
  ...
  public void initCreateMock() {
    Member AdminMember = createMember("관리자","admin","123456789a!");
      Item item1 = createItem("부대찌개", "/kit1.jpg", "부대찌개 입니다.", "다양한 햄과 소시지, 두부, 채소, 라면사리 등을 고추장 베이스 육수에 푹 끓여낸 얼큰하고 푸짐한 부대찌개입니다. 진한 국물맛과 풍성한 재료가 조화를 이루며, 한국식 퓨전 전골의 진수를 맛볼 수 있습니다.", 10000, 5, Category.SOUP, SubCategory.JJIGAE, ItemStatus.DISCOUNT);
      ...
      Item item7 = createItem("해산물토마토파스타", "/seatomatopasta.jpg", "해산물토마토파스타 입니다.", "새우, 오징어 등 다양한 해산물이 듬뿍 들어간 토마토 베이스 파스타입니다. 신선한 해산물의 풍미와 새콤달콤한 토마토 소스가 어우러져 입안 가득 바다의 향이 퍼집니다.", 13000, 5, Category.PASTA, SubCategory.Noodle, ItemStatus.DISCOUNT);
      Item item8 = createItem("토마토해장파스타", "/tomatohaejangPasta.jpg", "토마토해장파스타 입니다.", "매콤한 토마토 소스로 해장 효과를 더한 이색적인 파스타입니다. 얼큰하고 진한 소스가 속을 확 풀어주는 느낌을 주며, 숙취 해소에 좋은 이색 메뉴로 인기를 끌고 있습니다.", 12000, 5, Category.PASTA, SubCategory.Noodle, ItemStatus.DISCOUNT);
      ...
      Item item12 = createItem("베이컨토마토파스타", "/bacontomatoPasta.jpg", "베이컨토마토파스타 입니다.", "짭조름한 베이컨과 새콤달콤한 토마토 소스가 어우러진 파스타입니다. 풍부한 풍미와 간단하지만 감칠맛 나는 조합으로 누구나 만족하는 메뉴입니다.", 10500, 5, Category.PASTA, SubCategory.Noodle, ItemStatus.DISCOUNT);
      Item item13 = createItem("멜론 샤베트", "/Melonsorbet.jpg", "멜론 샤베트 입니다.", "시원하고 달콤한 멜론 맛이 살아있는 샤베트입니다. 부드럽고 상큼한 과일 풍미가 더위 속에 청량감을 선사하며, 디저트로 인기가 많습니다.", 3500, 10, Category.ANJU, SubCategory.SORBET, ItemStatus.DISCOUNT);
      Item item14 = createItem("레몬 샤베트", "/Lemonsorbet.jpg", "레몬 샤베트 입니다.", "톡 쏘는 상큼한 레몬의 맛이 살아있는 샤베트입니다. 입안이 상쾌해지는 청량감과 시원함으로 식사 후 입가심으로 제격입니다.", 3500, 10, Category.ANJU, SubCategory.SORBET, ItemStatus.DISCOUNT);
      ...
      Item item16 = createItem("요구르트 샤베트", "/Yogurtsorbet.jpg", "요구르트 샤베트 입니다.", "상큼하고 부드러운 요구르트의 풍미가 살아있는 샤베트입니다. 새콤달콤한 맛이 입안을 깔끔하게 정리해주며, 부담 없는 디저트로 좋습니다.", 3500, 10, Category.ANJU, SubCategory.SORBET, ItemStatus.DISCOUNT);
      ...
      Item item18 = createItem("샤인머스켓 샤베트", "/Shinesorbet.jpg", "샤인머스켓 샤베트 입니다.", "고급 포도 품종인 샤인머스켓의 달콤하고 풍부한 향을 담은 샤베트입니다. 깔끔하면서도 화사한 맛이 특징이며, 시원하고 고급스러운 디저트를 찾는 분들께 추천드립니다.", 3500, 10, Category.ANJU, SubCategory.SORBET, ItemStatus.DISCOUNT);
      ...
      Item item21 = createItem("참치 사시미", "/image21.jpg", "참치 사시미 입니다.", "신선한 참치를 도톰하게 썰어낸 사시미입니다. 부드럽고 진한 풍미가 입안에서 사르르 녹으며, 고소하면서도 깊은 맛이 일품입니다. 간장과 고추냉이를 곁들이면 특유의 감칠맛이 더욱 살아납니다.", 12000, 5, Category.JFOOD, SubCategory.FISH, ItemStatus.DISCOUNT);
      Item item22 = createItem("일식 도시락", "/image22.jpg", "일식 도시락 입니다.", "다양한 반찬이 정갈하게 담긴 정통 일식 도시락입니다. 구운 연어, 계란말이, 간장으로 조리한 버섯, 제철 채소절임 등으로 구성되어 있으며, 보기에도 먹기에도 만족스러운 프리미엄 도시락입니다.", 13000, 5, Category.JFOOD, SubCategory.REST, ItemStatus.DISCOUNT);
      ...
      Item item24 = createItem("참치 마요 주먹밥", "/image24.jpg", "참치 마요 주먹밥 입니다.", "부드럽고 고소한 참치마요네즈가 가득 들어간 일본식 주먹밥입니다. 한입 크기로 먹기 좋아 간편식으로 제격이며, 김과 밥의 조화로 담백하면서도 중독성 있는 맛을 자랑합니다.", 3500, 10, Category.JFOOD, SubCategory.REST, ItemStatus.DISCOUNT);
      ...
      Item item26 = createItem("닭가라아게", "/image26.jpg", "닭가라아게 입니다.", "겉은 바삭하고 속은 촉촉한 일본식 닭튀김입니다. 생강과 간장으로 재운 닭고기를 튀겨내어 고소하고 짭조름한 맛이 조화를 이루며, 맥주 안주나 간편한 한 끼로도 인기가 좋습니다.", 8000, 10, Category.JFOOD, SubCategory.JFRIED, ItemStatus.DISCOUNT);
      ...
      Item item28 = createItem("에비텐", "/image28.jpg", "에비텐 입니다.", "신선한 대하를 바삭한 튀김옷에 감싸 고온에서 튀겨낸 일본식 새우튀김입니다. 탱글탱글한 새우살과 바삭한 식감이 조화를 이루며, 튀김소스나 간장에 살짝 찍어 먹으면 더욱 맛이 살아납니다.", 6000, 5, Category.JFOOD, SubCategory.JFRIED, ItemStatus.DISCOUNT);
      ...
      Item item30 = createItem("츠케모노", "/image30.jpg", "츠케모노 입니다.", "무, 오이, 가지 등 다양한 채소를 소금과 식초, 다시 등에 절여 만든 일본 전통 반찬입니다. 아삭하고 새콤한 맛이 입맛을 돋우며, 느끼한 음식과 함께 먹으면 깔끔한 밸런스를 유지해줍니다.", 3000, 10, Category.JFOOD, SubCategory.REST, ItemStatus.DISCOUNT);
      ...
      Item item33 = createItem("장어 초밥", "/image33.jpg", "장어 초밥 입니다.", "달콤한 간장 양념에 구운 부드러운 장어를 올린 초밥입니다. 입안에서 녹는 듯한 장어와 달짝지근한 소스가 조화를 이루어 깊은 풍미를 전합니다.", 13000, 5, Category.JFOOD, SubCategory.SUSHI, ItemStatus.DISCOUNT);
      ...
      Item item35 = createItem("계란 초밥", "/image35.jpg", "계란 초밥 입니다.", "달콤하게 조리된 일본식 계란말이를 밥 위에 얹은 계란 초밥입니다. 부드러운 계란의 식감과 달짝지근한 맛이 특징으로, 어린이나 초밥 입문자에게 인기가 많습니다.", 9500, 5, Category.JFOOD, SubCategory.SUSHI, ItemStatus.DISCOUNT);
      ...
      Item item43 = createItem("순살 양념닭강정", "/image43.jpg", "순살 양념닭강정입니다.", "한입 크기의 순살 치킨에 달콤매콤한 양념을 입힌 닭강정입니다. 바삭함과 양념의 조화가 뛰어난 인기 안주입니다.", 10800, 5, Category.ANJU, SubCategory.GRILL, ItemStatus.DISCOUNT);
      ...
      Item item45 = createItem("간장 마늘 치킨", "/image45.jpg", "간장 마늘 치킨입니다.", "달콤짭짤한 간장 소스에 마늘향을 더해 바삭하게 튀긴 닭에 버무린 간장 마늘 치킨입니다. 부드러운 육질과 풍부한 맛이 특징입니다.", 11900, 5, Category.ANJU, SubCategory.GRILL, ItemStatus.DISCOUNT);
      ...
      Item item49 = createItem("새우 튀김", "/image49.jpg", "새우 튀김 입니다.", "큼직한 통새우를 바삭하게 튀겨내 탱글한 식감을 살렸습니다. 입안 가득 퍼지는 새우의 감칠맛이 일품인 인기 메뉴입니다.", 6000, 5, Category.ROAST, SubCategory.FRIED, ItemStatus.DISCOUNT);
      ...
      Item item51 = createItem("순대 볶음", "/image51.jpg", "순대 볶음 입니다.", "고소한 순대에 매콤한 양념을 더해 불맛을 살린 볶음 요리입니다. 쫀득한 식감과 중독성 있는 양념이 어우러져 밥 반찬으로도 딱입니다.", 18000, 5, Category.ROAST, SubCategory.BOKKEUM, ItemStatus.DISCOUNT);
      ...
      Item item53 = createItem("오징어 볶음", "/image53.jpg", "오징어 볶음 입니다.", "탱글한 오징어와 야채를 매콤하게 볶아낸 국민 반찬입니다. 불향 가득한 양념이 밥과 찰떡같이 어우러지는 매콤한 메뉴입니다.", 15000, 5, Category.ROAST, SubCategory.BOKKEUM, ItemStatus.DISCOUNT);
      ...
      Item item56 = createItem("순대국", "/image56.jpg", "순대국 입니다.", "진하게 고아낸 사골 육수에 순대와 머릿고기, 내장 등을 듬뿍 넣어 깊은 풍미를 자랑합니다. 구수하고 진한 국물이 속을 따뜻하게 감싸주며 든든한 한 끼를 완성합니다.", 9000, 5, Category.SOUP, SubCategory.JJIGAE, ItemStatus.DISCOUNT);
      ...
      Item item61 = createItem("감자탕", "/image61.jpg", "감자탕 입니다.", "돼지 등뼈와 푹 익은 감자, 시래기 등을 매콤한 양념으로 푹 끓여낸 얼큰한 국물 요리입니다. 뼈에 붙은 살점의 쫀득함과 얼큰한 국물이 어우러져 중독적인 맛을 자랑합니다.", 11000, 5, Category.SOUP, SubCategory.TANG, ItemStatus.DISCOUNT);
      ...
      Item item63 = createItem("소머리곰탕", "/image63.jpg", "소머리곰탕 입니다.", "소머리 고기를 정성껏 삶아낸 고소하고 진한 육수에 다양한 부위를 풍성하게 담았습니다. 쫄깃한 식감과 깔끔한 국물이 어우러져 속을 든든하게 채워줍니다.", 10000, 5, Category.SOUP, SubCategory.TANG, ItemStatus.DISCOUNT);
      Item item64 = createItem("삼계탕", "/image64.jpg", "삼계탕 입니다.", "영계 안에 찹쌀, 인삼, 대추, 마늘 등을 넣고 오랜 시간 끓여낸 보양식으로 영양이 풍부합니다. 따뜻한 국물과 부드러운 닭고기가 기력을 회복하는 데 안성맞춤입니다.", 9000, 5, Category.SOUP, SubCategory.TANG, ItemStatus.DISCOUNT);
      ...
      Item item66 = createItem("까르보나라", "/image66.jpg", "까르보나라 입니다.", "고소한 치즈와 진한 크림, 베이컨의 풍미가 어우러진 클래식한 크림 파스타입니다. 부드럽고 진한 소스가 면에 잘 어울려 깊은 감칠맛을 선사합니다.", 9500, 5, Category.PASTA, SubCategory.Noodle, ItemStatus.DISCOUNT);
      ...
      Item item69 = createItem("로제 파스타", "/image69.jpg", "로제 파스타 입니다.", "토마토소스와 크림소스를 조화롭게 섞어 부드럽고 새콤한 맛을 동시에 즐길 수 있습니다. 고소하면서도 살짝 매콤한 풍미가 입안을 감싸는 인기 메뉴입니다.", 11000, 5, Category.PASTA, SubCategory.Noodle, ItemStatus.DISCOUNT);
      ...
      Item item71 = createItem("새우 크림 파스타", "/image71.jpg", "새우 크림 파스타 입니다.", "탱글한 새우와 부드러운 크림소스가 만나 고소하면서도 깊은 풍미를 자랑합니다. 바다의 신선함과 부드러운 식감이 조화를 이루는 해산물 파스타입니다.", 12500, 5, Category.PASTA, SubCategory.Noodle, ItemStatus.DISCOUNT);
